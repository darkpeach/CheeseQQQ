...
# base_url = 'https://www.google.com/flights?hl=en#flt=SFO.PVG.2020-11-25;c:USD;e:1;a:UA;sd:1;t:f;tt:o'
time_out_seconds = 3 # set the time to wait till web fully loaded
executable_path = '/Users/hongruizhang/Desktop/fligth/CheeseQQQ/FlightCrawler/chromedriver' #请把zhangsan替换成你自己mac的用户名

option = webdriver.ChromeOptions()
option.add_argument('headless') 
driver = webdriver.Chrome('/Users/hongruizhang/Desktop/fligth/CheeseQQQ/FlightCrawler/chromedriver', chrome_options=option) #请把zhangsan改成你自己mac的用户名
driver.get(base_url)
...
for i in range(0,250): #刷250轮
	for my_date in search_dates:
		...
		try:
			...
			playsound('/Users/hongruizhang/Desktop/fligth/CheeseQQQ/FlightCrawler/found.mp3') #播放发现航班的提示音
...
playsound('/Users/hongruizhang/Desktop/fligth/CheeseQQQ/FlightCrawler/end.mp3') #播放结束提示音
driver.quit()  
